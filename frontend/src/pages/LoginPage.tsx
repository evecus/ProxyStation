...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('ProxyStation-token', res.token)
      navigate('/')
    } catch (err) {
      ...
      <div className={cn(
        ...
        <div className="text-center mb-8">
          <div className={cn(
            ...
            <img src="/proxystation-logo.png" alt="ProxyStation" className="w-16 h-16 object-contain" />
          </div>
          <h1 className={cn(
            'text-2xl font-bold',
        ...
        <p className={cn(
          ...
          © 2024 ProxyStation. All rights reserved.
        </p>
      </div>
    </div>
  )
