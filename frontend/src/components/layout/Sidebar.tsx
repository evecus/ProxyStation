...
const GITHUB_URL = 'https://github.com/star8618/ProxyStation'
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={cn(
                ...
                <img src="/proxystation-logo.png" alt="ProxyStation" className="w-8 h-8 object-contain" />
              </div>
              <div>
                <h1 className={cn(
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className={cn(
                ...
                <img src="/proxystation-logo.png" alt="ProxyStation" className="w-6 h-6 object-contain" />
              </div>
              <div>
                <div className={cn(
